...
public class SoftKeySignatureErrorConstant {
    ...
    public static final String SIGN_TRANS_PREPARE_SIGNABLE_TRANS_ERROR = "Error happened when trying to prepare signable transaction from serialized transaction %s";
    ...
    public static final String SIGN_TRANS_SEARCH_KEY_ERROR = "Error happened when trying to search for corresponding private key from input public key %s";
    public static final String SIGN_TRANS_KEY_NOT_FOUND = "Found no corresponding private key with input public key %s";
    public static final String SIGN_TRANS_GET_CURVE_DOMAIN_ERROR = "Error happened when trying to get EC Curve domain of %s";
    public static final String SIGN_TRANS_FORMAT_SIGNATURE_ERROR = "Error happened when trying to format signature!";
}
